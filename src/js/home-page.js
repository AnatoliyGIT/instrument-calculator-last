$(function($){
    ...
    // PRESSURE HTML
    $(".container")
        .append('<h1>Calculator</h1>')
        .append('<div class="press">')
    $(".press")
        .append('<div class="name-block"><h3 class="name">Pressure</h3></div>')
        .append('<div class="press-selector">')
    $(".press-selector")
        .append('<div class="press-left">')
        .append('<div class="press-right">')

    $(".press-left")
        .append('')
        .append('<div class="inputs" id="inputs-left">')
    $("#press-units-left")
        .append('<option value=10>MPA</option>')
        .append('<option value=1450>PSI</option>')
        .append('<option value=1021500>mm H2O</option>')
        .append('<option value=40146.32>In H2O (4 grad.C)</option>')
        .append('<option value=40218>In H2O (68 grad.F)</option>')
        .append('<option value=100>BAR</option>')
        .append('<option value=100000>mBAR</option>')
        .append('<option value=10000>kPa</option>')
        .append('<option value=2952>In Hg</option>')
        .append('<option value=75000>mm Hg</option>')
        .append('<option value=101.97>kg/cm2</option>')
        .append('<option value=101970>gm/cm2</option>')
        .append('<option value=101.97>ATM</option>')

    $("#inputs-left")
        .append('<input id=input-press type="number" placeholder="press" type="number">')

    $(".press-right")
        .append('<select name="units-right" id="press-units-right">')
        .append('<div class="inputs" id="inputs-right">')
    $("#press-units-right")
        .append('<option value=10>MPA</option>')
        .append('<option value=1450>PSI</option>')
        .append('<option value=1021500>mm H2O</option>')
    ...
    $("#inputs-right")
        .append('<input id=output-press type="number" placeholder="press" type="number" disabled>')
    $(".press")
        .append('<div class="buttons buttons-press"></div>')
    $(".buttons-press")
        .append('<button class="btn" id=calc-press>CALC</button>')

// TEMPERATURE HTML
    $(".container").append('<div class="temp">')
    $(".temp")
        .append('<div class="name-block"><h3 class="name">Temperature</h3></div>')
        .append('<div class="selector-center">')
        .append('<div class="temp-selector">')
    $(".selector-center")
        .append('<div><select name="temp-selector" id="temp-selector"></div>')
    $("#temp-selector")
        .append('<option value="termocouple">TERMOCOUPLE</option>')
        .append('<option value="rtd">RTD</option>')

    $(".temp-selector")
        .append('<div class="temp-left" id="termocouple-div" style="display: block">')
        .append('<div class="temp-left" id="rtd-div" style="display: none">')
        .append('<div class="temp-right">')

    $("#termocouple-div")
        .append('<select name="termocouple" id="termocouple">')
        .append('<div class="inputs inputs-termocouple">')
    $('#termocouple')
        .append('<option value="k">TYPE-K</option>')
        .append('<option value="j">TYPE-J</option>')
        .append('<option value="t">TYPE-T</option>')
        .append('<option value="r">TYPE-R</option>')
        .append('<option value="s">TYPE-S</option>')
        .append('<option value="e">TYPE-E</option>')
        .append('<option value="b">TYPE-B</option>')

    $('.inputs-termocouple')
        .append('<input id="input-termocouple" type="number" placeholder="mV">')
    $("#rtd-div")
        .append('<select name="rtd" id="rtd">')
        .append('<div class="inputs inputs-rtd">')
    $("#rtd")
        .append('<option value="100">PT-100</option>')
        .append('<option value="1000">PT-1000</option>')
    $(".inputs-rtd")
        .append('<input id="input-rtd" type="number" placeholder="Ohm">')

    $(".temp-right")
        .append('<div><p id="temp-right">Temp (-200...+1250)</p></div>')
        .append('<div><input id="input-temp" type="number" placeholder="&#176C"></div>')
    $(".temp")
        .append('<div class="buttons buttons-temp"></div>')
    $(".buttons-temp")
        .append('<button class="btn" id=calc-temp-left>CALC mV</button>')
        .append('<button class="btn" id=calc-temp-right>CALC &#176C</button>') */
